...
def get_config(config_string="full,language_conditioned"):
    ...
    FINETUNING_KWARGS = {
        ...
        "standardize_fn": ModuleSpec.create(
            "octo.data.oxe.oxe_standardization_transforms:kant_pick_dataset_transform",
        ),
    ...
    config = dict(
        ...
        eval_interval=5000,
        save_interval=5000,
        save_dir=f'/home/shivin/foundation_models/experiments/{exp_name}/',
        seed=42,
        wandb=dict(
