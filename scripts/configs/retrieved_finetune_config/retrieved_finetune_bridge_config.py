...
def get_config(config_string="br,0.05"):
    ...
    FINETUNING_KWARGS = {
        ...
        "load_keys": 'all',
        "dataset_statistics_path": "/mnt/hdd1/traj_data/bridge_dataset/0.1.0/dataset_statistics_487f3809fd5f5f7312a37d5e7349e18355d0440658903361620fb65d841dd44c.json",
