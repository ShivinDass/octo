...
exp_name = "easy_pick_wrist_proprio_h1_10traj"
def get_config(config_string="full,language_conditioned"):
    ...
    FINETUNING_KWARGS = {
        "name": "easy_pick_dataset_n5_2", #"easy_pick_dataset_n10",
        ...
        "dataset_statistics": "/home/shivin/tensorflow_datasets/easy_pick_dataset_n10/0.1.0/dataset_statistics_7f263ea7b63bc22b5d644da9d0f503ea0ad509cf109668b0e58c4e08144bcfa7.json",
    ...
    config = dict(
        ...
        save_dir=f'/home/shivin/foundation_models/experiments/',
        seed=42,
        wandb=dict(
