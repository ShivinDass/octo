...
# TASK="kitchen_scene3_turn_on_the_stove_and_put_the_moka_pot_on_it_h8_prechunk"
# TASK="living_room_scene6_put_the_white_mug_on_the_plate_and_put_the_chocolate_pudding_to_the_right_of_the_plate_h8_prechunk"
# TASK="living_room_scene1_put_both_the_alphabet_soup_and_the_cream_cheese_box_in_the_basket_h8_prechunk"
