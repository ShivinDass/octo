...
from octo.data.retrieved_dataset import RetrievedOctoDataset, print_nested_dict
...
#     # os.path.dirname(__file__), "configs/finetune_easy_pick_config.py"
#     os.path.dirname(__file__), "configs/finetune_bridge_config.py"
# )
...
def main(_):
    ...
    logging.info(
        ...
        Finetuning Dataset: {FLAGS.config.dataset_kwargs.data_paths}
    ...
    train_data_iter = map(process_batch, train_data_iter)
    example_batch = next(train_data_iter)
    print_nested_dict(example_batch)
