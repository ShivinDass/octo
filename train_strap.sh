...
do
    ...
    for seed in 0 1 2; do
        ...
        action_chunks=8
        TASK_PATH=strap/study_scene1_pick_up_the_book_and_place_it_in_the_back_compartment_of_the_caddy_demo100_chunk8_prechunk
        ...
        --config.seed $seed \
        --config.save_dir /mnt/hdd2/libero/experiments/${task_shorthand}_strap/  \
        --config.pretrained_path=hf://rail-berkeley/octo-small --name seed${seed}_libero_${task_shorthand}_h1_100 \
        --debug true \
