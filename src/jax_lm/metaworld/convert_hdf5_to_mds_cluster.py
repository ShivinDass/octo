...
def make_prior_dataset():
    return MetaworldDataset('/home/shivin/libero_experiments/data/metaworld/prior')
    

def make_seed_dataset():
    return MetaworldDataset('/home/shivin/libero_experiments/data/pick-place-wall')
...
def main():
    # dataset_name = 'seed/pick-place-wall'
    dataset_name = 'prior'

    if dataset_name == 'prior':
        dataset = make_prior_dataset()
    elif dataset_name == 'seed/pick-place-wall':
        dataset = make_seed_dataset()
    else:
        raise ValueError(f"Dataset {dataset_name} not supported")
    
    # for item in dataset:
    #     print(item['index'], item['action'].shape, item['observation'].shape)
    # exit()
    ...
    out_root = "/home/shivin/libero_experiments/data/mpt_dataset"
