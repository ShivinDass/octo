...
def train_policy(seed):
    ...
    model = make_mw_model(seed=seed, obs_dim=39)
    ...
    print("Success Rate:", policy_success)
...
if __name__ == "__main__":
    ...
    # show only 2 decimal places of success rate
    # print(f"Success Rate: {results[0][0]:.2f}")