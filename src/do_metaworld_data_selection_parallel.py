...
def grad_from_store(deps, batch_indices):
    '''
    shivin: understanding
    deps: what is it a dict of? Each value is a dict that maps batch number to the metagradients corresponding to it
    batch_indices: a dictionary where each batch id is mapped to a list of indices of the data points in that batch
    '''
